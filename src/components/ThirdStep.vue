                          ...
                          <div class="factory__wrapper">
                            ...
                            <div class="factory__info">
                              ...
                              <div class="factory__text">
                                Hochland производит плавленый сыр в России с
                                2000 года. В ноябре 2003 года был введен в
                                эксплуатацию новый завод в поселке РАОС,
                                Московской области.
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="slide-item__inner">
                          <div class="factory__wrapper">
                            ...
                            <div class="factory__info">
                              ...
                              <div class="factory__text">
                                В июле 2011 году Группа Hochland приобрела завод
                                в п.Прохоровка, Белгородской области. С середины
                  ...
                  <div class="tabs-content">
                    <div class="album__wrapper">
                      ...
                      >
                        <swiper-slide class="slide-item">
                          <img
                            src="https://sotni.ru/wp-content/uploads/2023/08/krasivye-pozitivnye-kartinki-2.webp"
                            alt=""
                          />
                        </swiper-slide>
                        <swiper-slide class="slide-item">
                          <img
                            src="https://lh3.googleusercontent.com/proxy/-2Vyb0CyidY6M85GGNm7HPVREaoMG4XPYwMggVn1LO99NhnAYD-Y9b3lkO_F6cC4DhFq6jlQf16Mhtz-NYIfPVWGxFVAtaK86_HRRT_NeF_j"
                            alt=""
                          />
                        </swiper-slide>
                        ...
                        <swiper-slide class="slide-item">
                          <img
                            src="https://avatars.dzeninfra.ru/get-zen_doc/1657335/pub_5caa10891a50ee00afbe6392_5caa1091bd3a3000b0738124/scale_1200"
                            alt=""
                          />
                        </swiper-slide>
...
.arrow-template {
  ...
  &[data-item="1"] {
    ...
    top: 52%;
    z-index: 4;
    transform: rotateZ(190deg) scaleY(-1);
  }
  ...
  &[data-item="4"] {
    ...
    top: 12%;
    z-index: 4;
    transform: rotateZ(151deg) scaleX(-1);
  }
