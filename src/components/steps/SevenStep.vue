      ...
      >
          ...
          <div class="man-modal" data-modal-dialog="23" v-if="moduleStep == 2">
            ...
            <div class="man-modal__content">
              <span>
                ...
                говорил по телефону о том, что впервые приехал
                в&nbsp;командировку на завод и переживаешь по этому поводу. Ты
        ...
        <transition name="fade-scale" mode="out-in">
          <div class="man-modal" data-modal-dialog="33" v-if="moduleStep == 12">
            ...
            <div class="man-modal__content">
              <span
                >Обязательно! После прохождения испытательного срока тебя
                подключат к программе. Причем ДМС можно получить не только на
                себя, но и на родственников первой линии: родители, супруги,
                дети. Меня очень это выручило неделю назад. Хорошо что, у меня
                была оформлена страховка на путешествие, я смог получить быстро
                и качественно все медицинские услуги. У ДМС в целом очень много
                плюсов!</span
              >
